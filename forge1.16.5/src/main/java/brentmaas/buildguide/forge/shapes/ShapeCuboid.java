...
public class ShapeCuboid extends Shape{
	...
	private PropertyNonzeroInt propertyX = new PropertyNonzeroInt(0, 3, new StringTextComponent("X"), () -> update());
	private PropertyNonzeroInt propertyY = new PropertyNonzeroInt(1, 3, new StringTextComponent("Y"), () -> update());
	private PropertyNonzeroInt propertyZ = new PropertyNonzeroInt(2, 3, new StringTextComponent("Z"), () -> update());
	private PropertyEnum<walls> propertyWalls = new PropertyEnum<walls>(3, walls.ALL, new TranslationTextComponent("property.buildguide.walls"), () -> update(), wallsNames);
