...
public class ShapeTorus extends Shape{
	...
	private PropertyPositiveInt propertyOuterRadius = new PropertyPositiveInt(1, 5, new TranslationTextComponent("property.buildguide.outerradius"), () -> updateOuter());
	private PropertyPositiveInt propertyInnerRadius = new PropertyPositiveInt(2, 3, new TranslationTextComponent("property.buildguide.innerradius"), () -> updateInner());
