...
import brentmaas.buildguide.fabric.property.PropertyInt;
...
public class ShapeCatenary extends Shape{
	...
	private PropertyInt propertyDx = new PropertyInt(0, 3, new TranslatableText("property.buildguide.delta", "X"), () -> update());
	private PropertyInt propertyDy = new PropertyInt(1, 0, new TranslatableText("property.buildguide.delta", "Y"), () -> update());
	private PropertyInt propertyDz = new PropertyInt(2, 0, new TranslatableText("property.buildguide.delta", "Z"), () -> update());
	private PropertyPositiveInt propertyAddLength = new PropertyPositiveInt(3, 1, new TranslatableText("property.buildguide.addlength"), () -> update());
