...
import brentmaas.buildguide.fabric.property.PropertyMinimumInt;
...
public class ShapePolygon extends Shape{
	...
	private PropertyMinimumInt propertySides = new PropertyMinimumInt(0, 3, new TranslatableText("property.buildguide.sides"), () -> update(), 3);
	...
	private PropertyEnum<direction> propertyDir = new PropertyEnum<direction>(2, direction.X, new TranslatableText("property.buildguide.direction"), () -> update(), directionNames);
	private PropertyEnum<rotation> propertyRot = new PropertyEnum<rotation>(3, rotation.ROT0, new TranslatableText("property.buildguide.rotation"), () -> update(), rotationNames);
