...
public class ShapeCatenary extends Shape{
	...
	private PropertyInt propertyDx = new PropertyInt(0, 3, new TranslatableComponent("property.buildguide.delta", "X"), () -> update());
	private PropertyInt propertyDy = new PropertyInt(1, 0, new TranslatableComponent("property.buildguide.delta", "Y"), () -> update());
	private PropertyInt propertyDz = new PropertyInt(2, 0, new TranslatableComponent("property.buildguide.delta", "Z"), () -> update());
	private PropertyPositiveInt propertyAddLength = new PropertyPositiveInt(3, 1, new TranslatableComponent("property.buildguide.addlength"), () -> update());
